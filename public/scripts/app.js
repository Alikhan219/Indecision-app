    ...
    _createClass(Options, [{
        ...
        value: function render() {
            return React.createElement(
                ...
                React.createElement(
                    "button",
                    { onClick: this.props.hasDeleteOptions },
                    "Remove"
                ),
                this.props.options.map(function (option) {
                    return React.createElement(Option, { key: option, keyText: option });
                }),
...
ReactDOM.render(React.createElement(IndecisionApp, null), document.getElementById('mainDiv'));
